      ...
      <main className="features-main flex-grow bg-[#f5f7fa] px-6 py-16">
        <section className="text-center mb-20">
          ...
          <p className="text-lg text-[#4a5568] max-w-3xl mx-auto">
            Discover how our AI-powered platform delivers unmatched cybersecurity through
            real-time monitoring, intelligent analytics, and robust reporting.
          </p>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="features-card bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              <img
                ...
                className="features-img rounded-lg mb-4"
              />
              <h3 className="text-xl font-semibold text-[#0a2540] mb-2">
                Real-Time Monitoring
              </h3>
              <p className="text-[#4a5568]">
                Stay ahead of threats with live updates and instant alerts powered by our
            ...
            <div className="features-card bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-[#4a5568]">
                Analyze user and network behavior to detect anomalies with precision and
            ...
            <div className="features-card bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-[#4a5568]">
                Generate comprehensive, customizable reports to audit system activity and
                ensure compliance.
              </p>
            </div>
            <div className="features-card bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-[#4a5568]">
                Securely manage access with distinct admin and user dashboards tailored to
                specific roles.
              </p>
            </div>
          </div>
        ...
        <section className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-[#4a5568] mb-6">
            Leverage CyberShield AI’s advanced features to protect your organization from
            evolving cyber threats.
          </p>
          <a
            href="/contact"
            className="features-cta bg-[#0056d2] text-white px-6 py-3 rounded-lg hover:bg-[#003bb5] transition-colors"
          >
            Get Started
          </a>
        </section>
